class Jogo {
    ...
    setup() {
      ...
      const inimigo = new Inimigo(matrizInimigo, imagemInimigo, width - 52, 40, 52, 52, 104, 104, 10, 100);
      const inimigoGrande = new Inimigo(matrizInimigoGrande, imagemInimigoGrande, width * 2, 0, 200, 200, 400, 400, 8, 100);
